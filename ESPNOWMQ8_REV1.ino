...
// ESP-NOW
//-------------------------------------------------------------------------------------
uint8_t RxMACaddress[] = {0x9C, 0x9C, 0x1F, 0xE8, 0xFA, 0x90}; // verificar con codigo 84:CC:A8:2C:1C:8C Esta es la dirección mac del otro ESP32


typedef struct TxStruct
{
  float H2; // PENDIENTE CAMBIAR int potval
}TxStruct;
TxStruct sentData;
...
void loop()
{
  ...
  MQ8.setA(987.99); MQ8.setB(-2.162); // Configure the equation to to calculate H2 concentration
